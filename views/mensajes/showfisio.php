...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div id="contenido">
        ...
        <?php if ($mostrarDatos): ?>
            ...
            <a href="index.php?tabla=usuarios&accion=administrar&id=<?= $_SESSION["usuario"]->nombre ?>" class="btn btn-primary"><i class="fa-solid fas fa-chevron-left"></i> Volver a Inicio</a>
        <?php endif; ?>
    </div>
</main>
